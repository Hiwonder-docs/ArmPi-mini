...
<img class="common_img" src="../_static/media/chapter_1/section_1/image12.jpeg"  alt="loading" />

<img class="common_img" src="../_static/media/chapter_1/section_1/image13.jpeg"  alt="loading" />
...
<img class="common_img" src="../_static/media/chapter_1/section_2/image10.png"  alt="loading" />
...
4)  接下来，请前往"**[6. 位置校准](#anchor_6)**"对机械爪进行夹取位置的校准（切勿跳过此步骤！）。
...
<img class="common_img" src="../_static/media/chapter_1/section_4/image2.png"  />

2)  点击"**Next**"按键。

<img class="common_img" src="../_static/media/chapter_1/section_4/image3.png"  />
...
6)  安装完成，点击图标<img src="../_static/media/chapter_1/section_4/image7.png"  />即可打开VNC。
...
<img class="common_img" src="../_static/media/chapter_1/section_4/image8.png"  alt="loading" />

2)  点击连接，输入密码"**hiwonder**"。

<img class="common_img" src="../_static/media/chapter_1/section_4/image9.png"  alt="loading" />

<img class="common_img" src="../_static/media/chapter_1/section_4/image10.png"  alt="loading" />

3)  连接成功后，打开VNC Viewer，在地址栏输入树莓派默认的IP地址：192.168.149.1，按下回车。如果出现安全连接相关的提示框，点击"Continue"按键即可。  
<img class="common_img" src="../_static/media/chapter_1/section_4/image11.png"  />
...
<tr>
<td style="text-align: center;"><img src="../_static/media/chapter_1/section_4/image14.png" style="width:0.625in;height:0.52083in" alt="loading" /></td>
<td><p>应用菜单，点击之后可选择不同应用。</p>
<p><img src="../_static/media/chapter_1/section_4/image15.png" style="width:1.45in;height:2.30972in" /></p></td>
</tr>
<tr>
<td style="text-align: center;"><img src="../_static/media/chapter_1/section_4/image16.png" style="width:0.62569in;height:0.56806in" alt="loading" /></td>
<td style="text-align: left;">系统自带浏览器</td>
</tr>
<tr>
<td style="text-align: center;"><img src="../_static/media/chapter_1/section_4/image17.png" style="width:0.62569in;height:0.52708in" alt="loading" /></td>
<td style="text-align: left;">文件管理器</td>
</tr>
<tr>
<td style="text-align: center;"><img src="../_static/media/chapter_1/section_4/image18.png" style="width:0.625in;height:0.42708in" alt="loading" /></td>
<td style="text-align: left;">LX终端，点击之后，可在打开界面输入命令行。</td>
</tr>
<tr>
<td style="text-align: center;"><img src="../_static/media/chapter_1/section_4/image19.png" style="width:0.62569in;height:0.71042in" alt="loading" /></td>
...
<tr>
<td style="text-align: center;"><img src="../_static/media/chapter_1/section_4/image21.png" style="width:0.30208in;height:0.42708in" alt="loading" /></td>
<td style="text-align: left;">点击可使系统桌面显示全屏或退出全屏。</td>
</tr>
<tr>
<td style="text-align: center;"><img src="../_static/media/chapter_1/section_4/image22.png" style="width:0.35417in;height:0.35417in" alt="loading" /></td>
<td style="text-align: left;">退出全屏。</td>
</tr>
<tr>
<td style="text-align: center;"><img src="../_static/media/chapter_1/section_4/image23.png" style="width:0.35417in;height:0.45347in" alt="loading" /></td>
...
<img class="common_img" src="../_static/media/chapter_1/section_5/image9.jpeg"  alt="loading" />

1)  我们拖动3号舵机的小滑杆，使机械臂呈直线（下图所示数值仅为参考，用户需调节目标，结合实际情况进行调节）。

<img class="common_img" src="../_static/media/chapter_1/section_5/image10.jpeg"  alt="loading" />

2)  然后点击"**保存偏差**"，将调节的偏差值保存到机械臂中。

<img class="common_img" src="../_static/media/chapter_1/section_5/image11.jpeg"  alt="loading" />
...
<img class="common_img" src="../_static/media/chapter_1/section_6/image16.png"  />
...
<img class="common_img" src="../_static/media/chapter_1/section_6/image7.jpeg"  alt="loading" />
...
<img class="common_img" src="../_static/media/chapter_1/section_6/image8.jpeg"  alt="loading" />

2)  点击"**运行到坐标点**"，让机械爪移动夹取区域，并观察此时机械爪与"**十**"字的偏差距离。

<img class="common_img" src="../_static/media/chapter_1/section_6/image9.jpeg"  alt="loading" />
...
<img class="common_img" src="../_static/media/chapter_1/section_6/image10.jpeg"  alt="loading" />
...
<img class="common_img" src="../_static/media/chapter_1/section_6/image13.jpeg"  alt="loading" />
...
<img class="common_img" src="../_static/media/chapter_1/section_6/image15.jpeg"  alt="loading" />
